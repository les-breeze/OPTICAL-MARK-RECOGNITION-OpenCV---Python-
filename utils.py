        ...
        for d in range(0, rows):
            for c in range(0, cols):
                ...
                cv2.putText(ver, lables[d][c], (eachImgWidth * c + 10, eachImgHeight * d + 20),
                            cv2.FONT_HERSHEY_COMPLEX, 0.7, (128, 0, 128), 2)
    return ver
...
def drawGrid(img, questions=20, choices=10):
...
def showAnswers(img, myIndex, grading, ans, questions=20, choices=10):
    ...
    for q in range(0, questions):
        ...
        if grading[q] == 1:
            ...
            myColor = (0, 255, 0)
            correctAns = ans[q]
            cv2.circle(img, ((correctAns * secW) + secW // 2, (q * secH) + secH // 2),
